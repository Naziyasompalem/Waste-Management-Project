    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('TaxIdentificationNumber', models.CharField(blank=True, max_length=50, null=True)),
                ('PickupAddress', models.CharField(blank=True, max_length=255, null=True)),
                ('BankAccountName', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('sellerpoints', models.PositiveIntegerField(blank=True, default=0, null=True)),
                ('Customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='seller', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='product',
